...
export default function CustomersPage() {
  ...
  return (
    <Stack spacing={2}>
      ...
      <Fab color="primary" onClick={() => setOpenAdd(true)} sx={{ position: "fixed", right: 20, bottom: "calc(64px + env(safe-area-inset-bottom) + 28px)", zIndex: 20 }} aria-label="add customer">
        <AddIcon />
      </Fab>
